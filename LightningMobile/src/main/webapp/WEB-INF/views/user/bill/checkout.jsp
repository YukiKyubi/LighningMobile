			...
			<div class="well">
				<form:form action="checkout" method="POST" modelAttribute="bill" class="form-horizontal">
					...
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="display_name" type="text" placeholder="Mời nhập tên" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">Email <sup>*</sup></label>
						<div class="controls">
							<form:input path="username" type="text" placeholder="Mời nhập email" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">Liên hệ <sup>*</sup></label>
						<div class="controls">
							<form:input path="phone" type="text" placeholder="Mời nhập sdt" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">Địa chỉ <sup>*</sup></label>
						<div class="controls">
							<form:textarea path="address" rows="5" cols="30" placeholder="Mời nhập địa chỉ" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">Ghi chú <sup>*</sup></label>
						<div class="controls">
							<form:textarea path="note" rows="5" cols="30" placeholder="Mời nhập ghi chú(nếu có)" />
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
